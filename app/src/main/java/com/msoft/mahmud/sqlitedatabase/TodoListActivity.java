...
import com.msoft.mahmud.sqlitedatabase.data.TodosContract;
import com.msoft.mahmud.sqlitedatabase.data.TodosContract.TodosEntry;
import com.msoft.mahmud.sqlitedatabase.data.TodosQueryHandler;
import com.msoft.mahmud.sqlitedatabase.model.Category;
import com.msoft.mahmud.sqlitedatabase.model.CategoryList;
import com.msoft.mahmud.sqlitedatabase.model.Todo;
...
//adds the click event to the listView, reading the content
    ...
    private void createTestTodos() {
        ...
        for (int i = 1; i<=20; i++) {
            ...
            values.put(TodosEntry.COLUMN_EXPIRED, "2017-08-08");
            int done = (i%2 == 1) ? 1 : 0;
    ...
    private void CreateCategory() {
        ...
        Uri uri = getContentResolver().insert(TodosContract.CategoriesEntry.CONTENT_URI,
                values);
    ...
    private void setCategories() {
        ...
        categoriesHandler.startQuery(1, null, TodosContract.CategoriesEntry.CONTENT_URI,
                null, null, null,
